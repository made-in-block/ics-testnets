#!/bin/bash
# Set up a cosmovisor service to join the mib-orion chain.
...
echo "Description=Cosmovisor Orion service"       | sudo tee /etc/systemd/system/cv-$NODE_MONIKER.service -a
...
echo "***********************"
echo "After you have updated the genesis file, start the Cosmovisor Orion service:"
